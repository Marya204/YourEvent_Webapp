...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 16 mai 2024 à 17:07
...
(5, 'Spectacle de danse traditionnelle', 'Un spectacle mettant en scène des danses traditionnelles marocaines.', '2024-09-11', 'Théâtre Royal, Marrakech', 'Spectacle', 'À venir', 60, 250),
(7, 'Festival Du Jazz', 'Festival de Jazz ', '2024-06-20', 'Theatre de Tanger', 'Festival', 'A venir', 600, 600),
(8, 'QDGQGT', 'KJHD', '2024-12-20', 'QSF', 'QSDF', 'QSDF', 23, 24);
...
(1, 'Fatima Zahra', 'fatima@example.com', 3),
...
(1, 'marysakouti@gmail.com', '0000'),
(2, 'lahrourinadia02@gmail.com', '5678\r\n'),
(3, 'misbahasmae123@gmail.com', '9999');
